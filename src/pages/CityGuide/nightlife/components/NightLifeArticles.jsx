    ...
    <div className="flex justify-center w-full">
      <div className="w-full max-w-[930px] mt-10 py-10">
        <div className="relative flex items-center justify-center mb-10">
          <div className="absolute w-[1120px] h-[4px] bg-[#EFEFEF]"></div>
        ...
        <div className="grid grid-cols-3 gap-x-8 gap-y-24">
          {[1,2,3,4,5,6,7,8,9].map((item) => (
            ...
            >
              ...
              <div className="mt-3 space-y-1">
                ...
                <p className="text-[14px] text-black font-[Author] leading-tight group-hover:text-[#7642C8]">
