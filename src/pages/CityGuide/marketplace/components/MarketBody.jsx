            ...
            <div className="max-w-[1120px] mx-auto px-4 max-sm:px-2">
                <article className="w-[740px] max-md:w-full">
                    ...
                    <div className="text-[24px] leading-[135%] tracking-[-0.9px] font-inter font-[281] text-black text-justify capitalize mt-8">
                        <p className="text-[24px] leading-[135%] tracking-[-0.9px] font-inter font-[281] text-black text-justify capitalize mt-8"><strong>Sydney's Christmas Markets</strong> <br /> <br />
                        ...
                        <p className="text-[24px] leading-[135%] tracking-[-0.9px] font-inter font-[281] text-black text-justify capitalize mt-8">
                        Top Picks: <br /> <br /> 
