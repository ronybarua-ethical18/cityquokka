    ...
    <section>
      <div className="flex flex-col gap-2">
        <img
          ...
          className='mt-20'
        />
        <div className="text-black font-inter text-[22px] font-[700] leading-[110%] tracking-[-0.9px] mb-10">
          1. FREE LISTING on the City Quokka City Guide
        </div>
      </div>


      <div className="w-full max-w-[1122px] max-md:max-w-full">
      ...
      <div className="flex flex-col gap-2">
        <img
          ...
          className='mt-20'
        />
        <div className="text-black font-inter text-[19px] font-[700] leading-[110%] tracking-[-0.9px] mb-20">
